...
pitchingStats = ['score','gp','gs','ip','h','r','er','bb','so','w','l','sv','blsv','war','whip','era','cg','sho','tbf','gf','svo','sh','sf','hbp','gdp','wp','bk','qs','qsp','k2bb','k29','pit','p2pa','p2ip','wper','ags','gb','fb','g2f','rs','erc','ercr','dips','dipr','tloss','cwin','pfr','babip','obtb','obb2','obb3','obhr','obrbi','obibb','obsb','obcs','obcsp','obbaa','obobp','obslg','obops']

battingStats = ['score','ab','r','h','b2','b3','hr','rbi','sb','cs','bb','so','avg','obp','slg','ops','war','rc','rc27','isop','seca','gb','fb','g2f','ab2hr','bb2pa','bb2k','gp','tpa','pit','p2pa','tb','xbh','hbp','gdp','sh','sf']
